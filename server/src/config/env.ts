...
try {
  ...
  // Parse comma-separated trusted origins into an array
  const trustedOrigins = parsedEnv.TRUSTED_ORIGIN.split(",")
  ...
  console.error(
    "Error occurred during validation of environment variables:",
    error,
  );
  process.exit(1);
}
